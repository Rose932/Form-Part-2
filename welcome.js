...
const products = [
    {
        id: 10001,
        name: "Apple",
        image: "https://cdn.pixabay.com/photo/2017/05/11/19/44/fresh-fruits-2305192__340.jpg", 
        description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sit amet leo tellus. Integer vitae lectus lacus. Sed scelerisque est id lectus commodo commodo. Cras in quam et magna aliquam congue. Duis vitae justo id ante semper convallis sed at felis. Integer mauris arcu, varius nec consectetur non, faucibus sit amet odio. Donec maximus dui ac ligula dignissim, non dapibus ipsum suscipit.",
        origin: "China", 
        price: 1.00, 
        quantity: 10
    },
...
window.onload = function() {
    ...
    for (var i=0; i < products.length; i++)
    {
         ...
         * 
         * > [ Goes Inside the Event Listener Function ] Use the createElement() method to create a new h2 and store it in a constant variable called cartItem
         * Referenced from: https://www.w3schools.com/jsref/met_document_createelement.asp
         * 
         ...
         * Referenced from: https://www.w3schools.com/jsref/met_document_createtextnode.asp
         * 
         * > [ Goes Inside the Event Listener Function ] Use the appendChild() method to append the text node with the product name to the cartItem div element
         * Referenced from: https://www.w3schools.com/jsref/met_node_appendchild.asp
         * 
         * > [ Goes Inside the Event Listener Function ] Use the createElement() method to create a new p and store it in a constant variable called cartItemPrice
         * Referenced from: https://www.w3schools.com/jsref/met_document_createelement.asp
         * 
         ...
         * Referenced from: https://www.w3schools.com/jsref/met_node_appendchild.asp
         * 
         * > [ Goes Inside the Event Listener Function ] Use the createElement() method to create a new p and store it in a constant variable called cartItemQuantity
         * Referenced from: https://www.w3schools.com/jsref/met_document_createelement.asp
         * 
         ...
         * Referenced from: https://www.w3schools.com/jsref/met_node_appendchild.asp
         * 
         * > [ Goes Inside the Event Listener Function ] Use the appendChild() method to append the cartItem div element to the cart div element
         * Referenced from: https://www.w3schools.com/jsref/met_node_appendchild.asp
         * 
         * > [ Goes Inside the Event Listener Function ] Use the appendChild() method to append the cart div element to the body element
         * Referenced from: https://www.w3schools.com/jsref/met_node_appendchild.asp
         * 
         ...
         * Referenced from: https://www.w3schools.com/jsref/met_document_createtextnode.asp
         * 
         * > [ Goes Inside the Event Listener Function ] Use the appendChild() method to append the text node with the cart total to the cartTotal div element
         * Referenced from: https://www.w3schools.com/jsref/met_node_appendchild.asp
         * 
         * > [ Goes Inside the Event Listener Function ] Use the appendChild() method to append the cartTotalText text node element to the cartTotal div element
         * Referenced from: https://www.w3schools.com/jsref/met_node_appendchild.asp
         * 
         * > [ Goes Inside the Event Listener Function ] Use the appendChild() method to append the cartTotal div element to the cartItem element
         * Referenced from: https://www.w3schools.com/jsref/met_node_appendchild.asp
         * 
         ...
         * Referenced from: https://www.w3schools.com/jsref/met_document_createtextnode.asp
         * 
         * > [ Goes Inside the Event Listener Function ] Use the appendChild() method to append the text node with the text "Checkout" to the cartButton div element
         * Referenced from: https://www.w3schools.com/jsref/met_node_appendchild.asp
         * 
         * > [ Goes Inside the Event Listener Function ] Use the appendChild() method to append the cartButton button element to the cartItem div element
         * Referenced from: https://www.w3schools.com/jsref/met_node_appendchild.asp
         * 
         * > [ Goes Inside the Event Listener Function ] Use the addEventListener() method to add an event listener to the cartButton button element
         * Referenced from: https://www.w3schools.com/jsref/met_element_addeventlistener.asp
         * 
         * > [ Goes Inside the Event Listener Function ] Use the preventDefault() method to prevent the default action of the event
         * Referenced from: https://www.w3schools.com/jsref/met_event_preventdefault.asp
         ...
         * Referenced from: https://www.w3schools.com/jsref/met_node_appendchild.asp
         * 
         * > [ Goes Inside the Event Listener Function ] Use removeChild to remove the item that was clicked on from the cart
        ...
        productButton.addEventListener("click", function(event) {
            ...
            // Cart Item Price implementation
            ...
            // Cart Item Quantity implementation
            ...
            // Append cart elements into cart item div
            ...
            // document.body.appendChild(cartDisplayDiv);
            ...
            const removeItemButtonText = document.createTextNode("Remove Item");
            ...
            removeItemButton.addEventListener("click", function(event){
                event.preventDefault();
                alert(`You removed the ${productName.innerText} from your cart.`)
